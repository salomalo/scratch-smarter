...
Your user name is your email address<br />".PHP_EOL."
...
2) Click on Dashboard<br />".PHP_EOL."
3) Click on (your state) Lottery ScratchSmarter Membership link<br />".PHP_EOL."
4) Click on (your State) this weeks report link<br />".PHP_EOL."
