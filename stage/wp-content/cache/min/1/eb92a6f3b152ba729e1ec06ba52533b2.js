...
{var dep=me.choicesDep[i][j]+form_identifier;if(isHidden||!checked||dep in hiddenByContainer)
{if(typeof toShow[dep]!='undefined')
{delete toShow[dep]['ref'][me.name+'_'+i];if($.isEmptyObject(toShow[dep]['ref']))
delete toShow[dep];}}
if(checked&&!isHidden&&!(dep in hiddenByContainer))
{if(typeof toShow[dep]=='undefined')
...
{var dep=me.choicesDep[i][j]+form_identifier;if(isHidden||$.inArray(i,selected)==-1||dep in hiddenByContainer)
{if(typeof toShow[dep]!='undefined')
{delete toShow[dep]['ref'][me.name+'_'+i];if($.isEmptyObject(toShow[dep]['ref']))
delete toShow[dep];}}
if($.inArray(i,selected)!=-1&&!isHidden&&!(dep in hiddenByContainer))
{if(typeof toShow[dep]=='undefined')
{$('#'+dep).closest('.fields').show();$('[id*="'+dep+'"].ignore').removeClass('ignore');toShow[dep]={'ref':{}};}
toShow[dep]['ref'][me.name+'_'+i]=1;if(typeof toHide[dep]!='undefined')
{result.push(dep);delete toHide[dep];}}
...
{if(!isHidden&&!(dep in hiddenByContainer))
