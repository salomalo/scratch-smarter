<?php
class Easy_Testimonials_Submission_Form_Options extends Easy_Testimonials_Pro_Options
{
	var $tabs;
	...
	function insert_submenu_page($submenu_pages){		
		...
		$this->insert_submenu_page_after_target(
			$submenu_pages,
			'easy-testimonials-advanced-settings',
...
?>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_title_field_label" id="easy_t_title_field_label" value="<?php echo get_option('easy_t_title_field_label', 'Title'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_title_field_description" id="easy_t_title_field_description"><?php echo get_option('easy_t_title_field_description', 'Please give your Testimonial a Title.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_title_field" id="easy_t_hide_title_field" value="1" <?php if(get_option('easy_t_hide_title_field', 0)){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_name_field_label" id="easy_t_name_field_label" value="<?php echo get_option('easy_t_name_field_label', 'Name'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_name_field_description" id="easy_t_name_field_description"><?php echo get_option('easy_t_name_field_description', 'Please enter your Full Name.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_name_field" id="easy_t_hide_name_field" value="1" <?php if(get_option('easy_t_hide_name_field', 0)){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_email_field_label" id="easy_t_email_field_label" value="<?php echo get_option('easy_t_email_field_label', 'Your E-Mail Address'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_email_field_description" id="easy_t_email_field_description"><?php echo get_option('easy_t_email_field_description', 'Please enter your e-mail address.  This information will not be publicly displayed.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_email_field" id="easy_t_hide_email_field" value="1" <?php if(get_option('easy_t_hide_email_field', 0)){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_position_web_other_field_label" id="easy_t_position_web_other_field_label" value="<?php echo get_option('easy_t_position_web_other_field_label', 'Position / Web Address / Other'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_position_web_other_field_description" id="easy_t_position_web_other_field_description"><?php echo get_option('easy_t_position_web_other_field_description', 'Please enter your Job Title or Website address.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_position_web_other_field" id="easy_t_hide_position_web_other_field" value="1" <?php if(get_option('easy_t_hide_position_web_other_field')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_other_other_field_label" id="easy_t_other_other_field_label" value="<?php echo get_option('easy_t_other_other_field_label', 'Location Reviewed / Product Reviewed / Item Reviewed'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_other_other_field_description" id="easy_t_other_other_field_description"><?php echo get_option('easy_t_other_other_field_description', 'Please enter the Location or the Product being Reviewed.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_other_other_field" id="easy_t_hide_other_other_field" value="1" <?php if(get_option('easy_t_hide_other_other_field')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_category_field_label" id="easy_t_category_field_label" value="<?php echo get_option('easy_t_category_field_label', 'Category'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_category_field_description" id="easy_t_category_field_description"><?php echo get_option('easy_t_category_field_description', 'Please select the Category that best matches your Testimonial.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_hide_category_field" id="easy_t_hide_category_field" value="1" <?php if(get_option('easy_t_hide_category_field')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_rating_field_label" id="easy_t_rating_field_label" value="<?php echo get_option('easy_t_rating_field_label', 'Your Rating'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_rating_field_description" id="easy_t_rating_field_description"><?php echo get_option('easy_t_rating_field_description', '1 - 5 out of 5, where 5/5 is the best and 1/5 is the worst.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_use_rating_field" id="easy_t_use_rating_field" value="1" <?php if(get_option('easy_t_use_rating_field')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_body_content_field_label" id="easy_t_body_content_field_label" value="<?php echo get_option('easy_t_body_content_field_label', 'Your Testimonial'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_body_content_field_description" id="easy_t_body_content_field_description"><?php echo get_option('easy_t_body_content_field_description', 'Please enter your Testimonial.'); ?></textarea>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_image_field_label" id="easy_t_image_field_label" value="<?php echo get_option('easy_t_image_field_label', 'Your Image'); ?>" />
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_image_field_description" id="easy_t_image_field_description"><?php echo get_option('easy_t_image_field_description', 'You can select and upload 1 image along with your Testimonial.  Depending on the website\'s settings, this image may be cropped or resized.  Allowed file types are .gif, .jpg, .png, and .jpeg.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					<td><input type="checkbox" name="easy_t_use_image_field" id="easy_t_use_image_field" value="1" <?php if(get_option('easy_t_use_image_field')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="easy_t_submit_button_label" id="easy_t_submit_button_label" value="<?php echo get_option('easy_t_submit_button_label', 'Submit Testimonial'); ?>" />
	...
	function output_notification_settings(){
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td><textarea name="easy_t_submit_success_message" id="easy_t_submit_success_message"><?php echo get_option('easy_t_submit_success_message', 'Thank You For Your Submission!'); ?></textarea>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td><input type="text" name="easy_t_submit_success_redirect_url" id="easy_t_submit_success_redirect_url" value="<?php echo get_option('easy_t_submit_success_redirect_url', ''); ?>"/>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td><input type="text" name="easy_t_submit_notification_address" id="easy_t_submit_notification_address" value="<?php echo get_option('easy_t_submit_notification_address'); ?>" />
		...
		<table class="form-table">
			<tr valign="top">
				<td><input type="checkbox" name="easy_t_submit_notification_include_testimonial" id="easy_t_submit_notification_include_testimonial" value="1" <?php if(get_option('easy_t_submit_notification_include_testimonial')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<fieldset>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_general_error" id="easy_t_general_error"><?php echo get_option('easy_t_general_error', 'There was an error with your submission.  Please check the fields and try again.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_title_field_error" id="easy_t_title_field_error"><?php echo get_option('easy_t_title_field_error', 'Please give ' . strtolower(get_option('easy_t_body_content_field_label','your testimonial')) . ' a ' . strtolower(get_option('easy_t_title_field_label','title')) . '.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_body_field_error" id="easy_t_body_field_error"><?php echo get_option('easy_t_body_field_error', 'Please enter ' . strtolower(get_option('easy_t_body_content_field_label','your testimonial')) . '.'); ?></textarea>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="easy_t_captcha_field_error" id="easy_t_captcha_field_error"><?php echo get_option('easy_t_captcha_field_error', 'Captcha did not match.'); ?></textarea>
	...
	function output_spam_settings(){
		...
		<table class="form-table">
			<tr valign="top">
				<td>
					<input type="checkbox" name="easy_t_use_captcha" id="easy_t_use_captcha" value="1" <?php if(get_option('easy_t_use_captcha')){ ?> checked="CHECKED" <?php } ?>/>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td><input type="text" name="easy_t_captcha_field_label" id="easy_t_captcha_field_label" value="<?php echo get_option('easy_t_captcha_field_label', 'Captcha'); ?>" />
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td><textarea name="easy_t_captcha_field_description" id="easy_t_captcha_field_description"><?php echo get_option('easy_t_captcha_field_description', 'Please enter the text that you see above here.'); ?></textarea>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="text" name="easy_t_recaptcha_api_key" id="easy_t_recaptcha_api_key" value="<?php echo get_option('easy_t_recaptcha_api_key', ''); ?>" />
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="text" name="easy_t_recaptcha_secret_key" id="easy_t_recaptcha_secret_key" value="<?php echo get_option('easy_t_recaptcha_secret_key', ''); ?>" />
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<select name="easy_t_recaptcha_lang" id="easy_t_recaptcha_lang">
