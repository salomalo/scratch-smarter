...
class GP_TestimonialForm{	
	...
	function __construct()
	{
		...
		//register Gutenburg block
		if ( function_exists( 'register_block_type' ) ) {
			register_block_type( 'easy-testimonials-pro/submit-testimonial', array(
				'editor_script' 	=> 'submit-testimonial-block-editor',
				'editor_style'  	=> 'submit-testimonial-block-editor',
				'style'         	=> 'submit-testimonial-block',
				'render_callback' 	=> array($this, 'submitTestimonialForm'),
			) );
		}		
		
		// add media buttons to admin
		add_filter ( 'easy_t_admin_media_buttons', array($this, 'add_media_buttons') );
	}
	
	//add media buttons
	function add_media_buttons( $media_buttons ){		
		//submit testimonial widget
		$media_buttons[] = array (
			'title' => 'Testimonial Form', 
			'shortcode' => get_option('ezt_submit_testimonial_shortcode', 'submit_testimonial'),
			'widget_class' => 'submittestimonialwidget',
