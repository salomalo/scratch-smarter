...
final class AffiliateWP_AFNF_Register extends NF_Abstracts_Action {
	...
	public function process( $action_settings, $form_id, $data ) {
		 ...
		 * @var string
		 */
		$first_name = $action_settings[ 'firstname' ];
		 ...
		 * @var string
		 */
		$last_name = $action_settings[ 'lastname' ];
		 ...
		 * @var string
		 */
		$password = $action_settings[ 'password' ];
		 ...
		 * @var string
		 */
		$payment_email = $action_settings[ 'payment_email' ];
		 ...
		 * @var string
		 */
		$promotion_method = $action_settings[ 'promotion_method' ];
		 ...
		 * @var string
		 */
		$website_url = $action_settings[ 'website_url' ];
