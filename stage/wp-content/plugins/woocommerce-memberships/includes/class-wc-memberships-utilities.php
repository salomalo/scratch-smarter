...
class WC_Memberships_Utilities {
	...
	public function __construct() {
		...
		// load framework handlers
		require_once( $plugin->get_framework_path() . '/utilities/class-sv-wp-async-request.php' );
		require_once( $plugin->get_framework_path() . '/utilities/class-sv-wp-background-job-handler.php' );
		// load abstracts
