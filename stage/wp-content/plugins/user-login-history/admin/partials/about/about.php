<div class="clearfix">
    <div class="user-login-history-right-col">
        ...
        ?></h2>
        <h4><?php _e('This plug-in allows you to track any visitor with the following attributes:', 'user-login-history'); ?></h4>
        <ol>
        ...
        <h4><?php _e('Do you want to translate this plug-in to another language?', 'user-login-history'); ?></h4>
        <p><?php echo sprintf(__('I recommend using <a target="_blank" href="%1$s">POEdit</a> or if you prefer to do it straight from the WordPress admin interface use <a target="_blank" href="%2$s">Loco Translate</a>. When you’re done, send me the file(s) and I’ll add it to the official plug-in.', 'user-login-history'), 'http://poedit.net', 'https://wordpress.org/plugins/loco-translate/'); ?></p>
 ...
 <h3><?php _e('I am here!', 'user-login-history'); ?></h3>
        ...
        <p> <span><?php _e('Skype ID:', 'user-login-history'); ?> <b>erfaiyazalam</b></span></p>
    </div>
